# data-platform-api-production-order-headers-creates-subfunc-rmq-kube
data-platform-api-production-order-headers-creates-subfunc-rmq-kube は、データ連携基盤において、オーダーAPIサービスのヘッダ登録補助機能を担うマイクロサービスです。
...
## 対象APIサービス
data-platform-api-production-order-headers-creates-subfunc-rmq-kube の 対象APIサービスは次の通りです。

*  APIサービス URL: https://xxx.xxx.io/api/API_ORDERS_SRV/creates/

## 本レポジトリ が 対応する データ
data-platform-api-production-order-headers-creates-subfunc-rmq-kube が対応する データ は、次のものです。
...
## Output
data-platform-api-production-order-headers-creates-subfunc-rmq-kube では、[golang-logging-library-for-data-platform](https://github.com/latonaio/golang-logging-library-for-data-platform) により、Output として、RabbitMQ へのメッセージを JSON 形式で出力します。以下の項目のうち、"cursor" ～ "time"は、golang-logging-library-for-data-platform による 定型フォーマットの出力結果です。
